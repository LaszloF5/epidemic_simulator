    ...
    for person in people:
        ...
        for other_person in people:
            if id(person) != id(other_person):
                if other_person.x - 2*PERSON_AURA < person.x < other_person.x + 2*PERSON_AURA and \
                    other_person.y - 2*PERSON_AURA < person.y < other_person.y + 2*PERSON_AURA:
...
def draw(people):
    ...
    pygame.draw.circle(screen, PERSON_COLOR_CLEAR, (795, 20), PERSON_AURA, 0)
    pygame.draw.circle(screen, PERSON_COLOR_INFECTED, (950, 20), PERSON_AURA, 0)
    pygame.draw.circle(screen, PERSON_COLOR_IMMUNE, (1120, 20), PERSON_AURA, 0)
    pygame.draw.circle(screen, PERSON_COLOR_CLEAR, (1240, 20), PERSON_AURA, 5)
